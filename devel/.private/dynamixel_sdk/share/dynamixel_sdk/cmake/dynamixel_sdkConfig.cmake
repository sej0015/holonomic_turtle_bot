...
if(NOT "/home/smart5/dynamixel-workbench/src/dynamixel_sdk/include " STREQUAL " ")
  set(dynamixel_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/home/smart5/dynamixel-workbench/src/dynamixel_sdk/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/smart5/dynamixel-workbench/src/dynamixel_sdk/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/smart5/dynamixel-workbench/devel/.private/dynamixel_sdk/lib;/home/smart5/dynamixel-workbench/devel/lib;/home/smart5/turtlebot_sim/devel/lib;/opt/ros/melodic/lib)
