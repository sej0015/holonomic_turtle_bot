...
if(NOT "/home/turtle/holonomic_turtle_bot/src/dynamixel_sdk/include " STREQUAL " ")
  set(dynamixel_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/home/turtle/holonomic_turtle_bot/src/dynamixel_sdk/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtle/holonomic_turtle_bot/src/dynamixel_sdk/${idir}'.  ${_report}")
    endif()
